    ...
    public class ProfilePanel : Panel, IRefreshable
    {
        ...
        private void Avatar_Paint(object? sender, PaintEventArgs e)
        {
            ...
            if (user?.Avatar != null)
            {
                ...
                catch { DrawAvatarPlaceholder(e, pb); }
            }
            else
            {
    ...
    public class CreateProductPanel : Panel, IRefreshable
    {
        ...
        private void BtnCreate_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ConvertImageToBytes() is byte[] imgBytes)
                {
                    product.ProductImage = imgBytes;
                    _context.SaveChanges();
                }
                ...
                txtName.Clear(); txtDescription.Clear(); txtPrice.Clear(); cmbCategory.Text = "";
